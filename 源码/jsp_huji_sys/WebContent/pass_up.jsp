...
if(user_name==null) { 
	out.println("<script>alert('���ȵ�¼ϵͳ���޸����룡');window.history.back();</script>");
}
%>
<form id="form1" name="form1" action="pass_chuli.jsp">
  <table width="830" height="487" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td valign="top" style="padding-left:15px; padding-top:15px;" background="image/right.jpg"><table width="500" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="35">&nbsp; �û�������
            <input name="username" type="text" id="username" readonly value="<%=user_name %>"/></td>
        </tr>
        <tr>
          <td height="35">&nbsp; �û����룺
        ...
        <tr>
          <td height="40">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="submit" name="Submit" value="�޸�" />
