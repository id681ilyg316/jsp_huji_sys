...
<form id="form1" name="form1" action="tousu_chuli.jsp">
  <table width="830" height="487" border="0" cellpadding="0" cellspacing="0">
    <tr> 
      <td valign="top" style="padding-left:15px; padding-top:15px;" background="image/right.jpg"><table width="500" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="40">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="submit" name="Submit" value="Ͷ��" />
        ...
        <table width="500" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="93" height="29" align="center" bgcolor="#CCCCCC">�û���</td>
            <td width="300" align="center" bgcolor="#CCCCCC">����</td>
            <td width="300" align="center" bgcolor="#CCCCCC">������</td>
            <td width="107" align="center" bgcolor="#CCCCCC">��ʱ��</td>
          </tr>
<%	
int CountPage = 0;
int CurrPage = 1;
	...
	try
	{
		...
		%>
          <tr>
            ...
            <td height="23" align="center"><%=rs.getString("title")%></td>
